...
export default class BaseService {
  ...
  get_token_auth(url, input_dataset) {
    return this.axiosInstance.get(
      this.API_URL + url,
      requestOptions.getToken(input_dataset)
    );
  }
  ...
  post_token_auth(url, body, input_dataset) {
    ...
    return this.axiosInstance.post(
      this.API_URL + url,
      body,
      requestOptions.postToken(input_dataset)
    );
  }
  ...
  patch_auth(url,body) {
    ...
    return this.axiosInstance.post(this.API_URL + url,
         body,
          requestOptions.patch()
          );
  }
  patch_token_auth(url, body, input_dataset) {
    console.log("sending post via base service");
    return this.axiosInstance.post(
      this.API_URL + url,
      body,
      requestOptions.patchToken(input_dataset)
    );
  }
  patch(url, body) {
    console.log("sending patch via base service");
