        ...
        <div class="dropdown-menu compact-form" :class="{ 'show' : visible === true }" aria-labelledby="dropdownMenuButton" 
            ...
            <div class="container">
                <div class="card p-2">
                    ...
                    <div class="selected-file-cards">  <!--loop through all the selected here -->
                        <button class="btn btn-outline file" v-for = "(file,index) in workflowDashboard.searchQuery.filterByFiles" v-bind:file="file" v-bind:index="index" v-bind:key="file.id">
                            <svg class="user-remove" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" @click="removeFile(index)">
