			...
			<div class="container">
				<div class="card p-2">
					...
					<div class="selected-workflow-cards">  <!--loop through all the selected here -->
						<button class="btn btn-outline workflow" v-for = "(selectedItem, index) in this.selectedItems" v-bind:selectedItem="selectedItems" v-bind:index="index" v-bind:key="selectedItem.id">
