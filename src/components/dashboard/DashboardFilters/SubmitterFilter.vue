		...
		<div class="dropdown-menu compact-form" :class="{ 'show' : visible === true }" aria-labelledby="dropdownMenuButton" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 38px, 0px);">
			<form class="main-dropdown">
				<div class="container-fluid">
					...
					<div class="input-group mb-3">
						<typeahead :source="getSubmitters" filter-key="submitter" filter-type="contains" :start-at="1"
			...
			<div class="container">
				<div class="card p-2">
					...
					<div class="selected-submitter-cards">  <!--loop through all the selected here -->
						<button class="btn btn-outline submitter" v-for = "(submitter,index) in workflowDashboard.searchQuery.filterBySubmitters" v-bind:submitter="submitter" v-bind:index="index" v-bind:key="submitter.id">
