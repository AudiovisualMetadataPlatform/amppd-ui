   ...
   <div class="card pad-all-2">
      ...
      <div class="scroll-div">
         <ul class="list-unstyled">
            <li v-for="(param, index) in workflowSubmission.selectedWorkflowParameters" v-bind:key="index" class="node-li">
         ...
         <div>
            <div>
               ...
               <ul class="list-unstyled file-list">
                  <li v-for="(file, index) in selectedFilesArray" v-bind:key="index" v-bind:value="file.id" class="file-list-item" data-toggle="tooltip" v-bind:title="file.name">
                     <button class="btn file-name bx-shadow">
                     ...
                     <button class="btn file-name bx-shadow"> {{file.originalFilename}}</button>
