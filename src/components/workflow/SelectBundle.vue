            ...
            <div class="card-header" id="headingTwo">
               <h3 class="mb-0">
                <div class="btn btn-link bundle" :class="{ 'collapsed': visible !== index }" :key="bundle.id" 
                  ...
                  <button class="btn btn-link float-right add-to-bundle" v-on:click="addAllFiles(bundle)" v-bind:disabled=allSelected(bundle) :key="updateSelectedFiles">
            ...
            <div id="collapseTwo" class="collapse" :class="{ 'show' : visible === index }" aria-labelledby="headingTwo" data-parent="#accordion">
               <div class="card-body">
                  ...
                  <ul class="list-unstyled file-list" >
                     <li v-for="(primaryfile, indexPf) in bundle.primaryfiles" v-bind:key="indexPf" class="file-list-item" data-toggle="tooltip" v-bind:title="primaryfile.name">
                        <button class="btn btn-light btn-sm file-name" :disabled="true">
