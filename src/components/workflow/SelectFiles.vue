            ...
            <div id="collapseTwo" class="collapse" :class="{ 'show' : visible === index }" aria-labelledby="headingTwo" data-parent="#accordion">
               <div class="card-body">
                  ...
                  <ul class="list-unstyled file-list" >
                     <li v-for="(primaryfile, file_index) in item.primaryFiles" v-bind:key="file_index">
                        <button class="btn btn-light btn-sm" :disabled=hasValue(primaryfile.id) :key="updateSelectedFiles">
