			...
			<div class="container">
				<div class="card p-2">
					...
					<div>  <!--loop through all the selected here -->
						<button class="btn btn-outline submitter" v-for = "submitter in selectedSubmitters" v-bind:submitter="submitter" v-bind:key="submitter.id">
...
export default {
  ...
  methods:{
	...
	addSubmitter($event){
		...
		console.log("selected submitters are:"+this.selectedSubmitters);
	}
  },
  watch: {
