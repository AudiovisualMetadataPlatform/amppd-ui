    ...
    >
      <form class="main-dropdown">
        <div class="container-fluid">
          <label for="colFormLabelSearch" class="bold form-label">{{ name }}</label>
        ...
        <div class="card p-2">
          ...
          <div class="selected-workflow-cards">
            ...
            <button
              ...
              v-for="(selectedItem, index) in this.selectedItems"
              v-bind:selectedItem="selectedItems"
              v-bind:index="index"
              v-bind:key="index"
            >
              <svg
