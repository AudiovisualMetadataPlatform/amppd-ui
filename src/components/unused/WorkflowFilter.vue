<template>
  <div class="dropdown">
    <button
      ...
      :class="{
        show: workflowDashboard.filtersEnabled.workflowFilter === true,
      }"
      type="button"
      id="dropdownMenuButton1"
      data-toggle="dropdown"
      aria-haspopup="true"
      aria-expanded="workflowDashboard.filtersEnabled.workflowFilter ? 'true' : 'false'"
    ...
    >
      <form class="main-dropdown">
        <div class="container-fluid">
          <label for="colFormLabelSearch" class="bold form-label">Workflow Name</label>
        ...
        <div class="card p-2">
          ...
          <div class="selected-workflow-cards">
            ...
            <button
              ...
              v-for="(workflow, index) in workflowDashboard.searchQuery
                .filterByWorkflows"
...
export default {
  ...
  methods: {
    setFilterFlags() {
      this.workflowDashboard.filtersEnabled.workflowFilter = !this
        .workflowDashboard.filtersEnabled.workflowFilter;
  ...
  watch: {
    selectedWorkflows: function() {
      this.selectedWorkflows.length > 0
        ? (this.workflowDashboard.filtersEnabled.workflowFilter = true)
        : (this.workflowDashboard.filtersEnabled.workflowFilter = false);
    },
  },
};
