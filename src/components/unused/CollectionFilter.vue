<template>
  <div class="dropdown">
    <button
      ...
      :class="{
        show: workflowDashboard.filtersEnabled.collectionFilter === true,
      }"
      type="button"
      id="dropdownMenuButton1"
      data-toggle="dropdown"
      aria-haspopup="true"
      aria-expanded="workflowDashboard.filtersEnabled.collectionFilter ? 'true' : 'false'"
    ...
    >
      <form class="main-dropdown">
        <div class="container-fluid">
          <label for="colFormLabelSearch" class="bold form-label">Collection Name</label>
      ...
      <div class="container">
        <div class="card p-2">
          ...
          <div class="selected-workflow-cards">
            <!--loop through all the selected here -->
            <button
              class="btn btn-outline workflow"
              v-for="(collection, index) in workflowDashboard.searchQuery
                .filterByCollections"
...
export default {
  ...
  methods: {
    setFilterFlags() {
      this.workflowDashboard.filtersEnabled.collectionFilter = !this
        .workflowDashboard.filtersEnabled.collectionFilter;
  ...
  watch: {
    selectedCollections: function() {
      this.selectedCollections.length > 0
        ? (this.workflowDashboard.filtersEnabled.collectionFilter = true)
        : (this.workflowDashboard.filtersEnabled.collectionFilter = false);
    },
  },
};
