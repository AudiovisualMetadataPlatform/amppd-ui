<template>
  <div class="dropdown">
    <button
      ...
      :class="{ show: workflowDashboard.filtersEnabled.stepFilter === true }"
      type="button"
      id="dropdownMenuButton1"
      data-toggle="dropdown"
      aria-haspopup="true"
      aria-expanded="workflowDashboard.filtersEnabled.stepFilter ? 'true' : 'false'"
    ...
    >
      <form class="main-dropdown">
        <div class="container-fluid">
          <label for="colFormLabelSearch" class="bold form-label">Workflow Step</label>
      ...
      <div class="container">
        <div class="card p-2">
          ...
          <div class="selected-step-cards">
            <!--loop through all the selected here -->
            <button
              class="btn btn-outline step"
...
export default {
  ...
  methods: {
    setFilterFlags() {
      this.workflowDashboard.filtersEnabled.stepFilter = !this.workflowDashboard
        .filtersEnabled.stepFilter;
  ...
  watch: {
    selectedSteps: function() {
      this.selectedSteps.length > 0
        ? (this.workflowDashboard.filtersEnabled.stepFilter = true)
        : (this.workflowDashboard.filtersEnabled.stepFilter = false);
    },
  },
};
