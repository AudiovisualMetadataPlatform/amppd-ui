<template>
  <div class="dropdown">
    <button
      ...
      :class="{ show: workflowDashboard.filtersEnabled.itemFilter === true }"
      type="button"
      id="dropdownMenuButton1"
      data-toggle="dropdown"
      aria-haspopup="true"
      aria-expanded="workflowDashboard.filtersEnabled.itemFilter ? 'true' : 'false'"
    ...
    >
      <form class="main-dropdown">
        <div class="container-fluid">
          <label for="colFormLabelSearch" class="bold form-label">Source Item</label>
      ...
      <div class="container">
        <div class="card p-2">
          ...
          <div class="selected-item-cards">
            <!--loop through all the selected here -->
            <button
              class="btn btn-outline item"
...
export default {
  ...
  methods: {
    setFilterFlags() {
      this.workflowDashboard.filtersEnabled.itemFilter = !this.workflowDashboard
        .filtersEnabled.itemFilter;
  ...
  watch: {
    selectedItems: function() {
      this.selectedItems.length > 0
        ? (this.workflowDashboard.filtersEnabled.itemFilter = true)
        : (this.workflowDashboard.filtersEnabled.itemFilter = false);
    },
  },
};
